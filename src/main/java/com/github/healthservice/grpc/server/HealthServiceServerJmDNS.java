...
public class HealthServiceServerJmDNS {
    public static void main(String[] args) throws IOException, InterruptedException {
        System.out.println("This is the gRPC server");

        HealthServiceServerJmDNS healthServiceServerJmDNS = new HealthServiceServerJmDNS();

        Properties properties = healthServiceServerJmDNS.getProperties();

        healthServiceServerJmDNS.registerService(properties);
...
//        ssr2.run(port, service_type, service_name);
    ...
    public Properties getProperties() {
        ...
        try (InputStream input = new FileInputStream("src/main/properties/healthservice.properties")) {
            ...
            System.out.println("Health Service properties ...");
