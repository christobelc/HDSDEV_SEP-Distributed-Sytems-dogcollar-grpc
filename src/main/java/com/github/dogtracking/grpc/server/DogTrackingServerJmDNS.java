...
public class DogTrackingServerJmDNS{
    public static void main(String[] args) throws IOException, InterruptedException {
        System.out.println("This is the gRPC server");

        DogTrackingServerJmDNS dogTrackingServer1 = new DogTrackingServerJmDNS();

        Properties properties = dogTrackingServer1.getProperties();

        dogTrackingServer1.registerService(properties);
    ...
    public Properties getProperties() {
        ...
        try (InputStream input = new FileInputStream("src/main/properties/dogtracking.properties")) {
            ...
            System.out.println("Dog tracking Service properties ...");
